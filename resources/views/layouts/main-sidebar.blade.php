				...
				<ul class="side-menu">
					...
					<li class="slide">
						...
						<ul class="slide-menu">
							...
							<li><a class="slide-item" href="{{ route('invoice-partial')}} ">الفواتير المدفوعة جزئيا</a></li>
							@endcan

							@can('ارشيف الفواتير')
							<li><a class="slide-item" href="{{ route('soft.index')}}"> ارشيف الفواتير </a></li>
							@endcan
				...
				@can('التقارير')
					...
					<li class="slide">
						...
						<ul class="slide-menu">
							...
							@can('تقارير الفواتير')
							<li><a class="slide-item" href="{{ url('/' . $page='Search_invoices') }}">تقارير الفواتير</a></li>
							@endcan

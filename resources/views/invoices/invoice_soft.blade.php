...
@section('page-header')
				...
				<div class="breadcrumb-header justify-content-between">
					<div class="my-auto">
						<div class="d-flex">
							<h4 class="content-title mb-0 my-auto">الفواتير</h4><span class="text-muted mt-1 tx-13 mr-2 mb-0">/ الفواتير المحذوفة </span>
						</div>
			...
			<div class="modal-content">
				...
				<form action="{{route('restore')}}" method="POST">
					...
					<div class="modal-body">
						<p>هل انت متاكد من عملية الاسترجاع ؟</p><br>
        ...
        <div class="modal fade" id="modaldemo9" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <form action="soft/destroy" method="POST">
                        @method('DELETE')
                        @csrf
                        <div class="modal-body">
													...
													<div class="dropdown">
														...
														<div  class="dropdown-menu tx-13">
                                                            ...
                                                            <button class="dropdown-item" data-invoice_id="{{ $invoice->id }}"
                                                                ...
                                                                data-target="#restore">نقل الي الفواتير</button>		
																											
                                                            <button class="dropdown-item" data-invoice_id="{{ $invoice->id }}"
																data-invoice_number="{{$invoice->invoice_number }}" data-toggle="modal"
                                                                data-target="#modaldemo9">الحذف نهائيا</button>
														</div>
													</div>
